...
def add_note_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    custom_fields_decision_fp_value = container.get("custom_fields", {}).get("decision_fp", None)
    ...
    phantom.add_note(container=container, content=custom_fields_decision_fp_value, note_format="markdown", note_type="general", title="3단계에서 판단한 결과")
...
def update_event_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act("update event", parameters=parameters, name="update_event_1", assets=["splunk_notable_insider"], callback=set_status_9)
